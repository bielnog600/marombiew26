                  ...
                  <CardContent className="p-4">
                    ...
                    {isExpanded && (
                      <div className="mt-4 pt-4 border-t border-border/50 space-y-4">
                        ...
                        <div className="bg-violet-500/5 border border-violet-500/20 rounded-lg p-3 mb-3 space-y-3">
                          ...
                          <p className="text-[10px] text-muted-foreground italic">
                            * Se selecionado manualmente, a IA respeitará rigorosamente estas quantidades.
                          </p>
                        </div>
