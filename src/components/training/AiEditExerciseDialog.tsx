...
const QUICK_OPTIONS: { label: string; instruction: string; group: string }[] = [
  // Adicionar grupos
   ...
   { group: 'Intensidade', label: '+ Bi-set', instruction: 'Combine o 1º e 2º exercícios e o 3º e 4º exercícios em Bi-sets (sem descanso entre eles).' },
   { group: 'Intensidade', label: '+ GVT (10x10)', instruction: 'Escolha o primeiro exercício composto e aplique o método GVT (10 séries de 10 repetições com 60s de descanso).' },
   { group: 'Adicionar', label: '+ Manguito', instruction: 'Adicione 2 exercícios de rotação interna/externa de manguito rotador no início como aquecimento.' },
   { group: 'Adicionar', label: '+ Pescoço', instruction: 'Adicione 1 exercício de flexão/extensão de pescoço (foco em fortalecimento cervical).' },
